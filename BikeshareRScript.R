...
library(ggplot2)
names(bK)
qplot(x = Gender, y = (2021-Birth.Year), data = bk,
      geom = 'boxplot',ylim=c(20, 80), main = 'Biker Share Users Age', xlab = 'Gender', ylab = 'Age, Years')
qplot(x = Gender, y = (Trip.Duration), data = bk,
      geom = 'boxplot',ylim=c(0,60), main = 'Trip Duration, min', xlab = 'Gender', ylab = 'Trip Duration, Minutes')
